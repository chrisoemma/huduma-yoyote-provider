import { View, Text, Dimensions, TouchableOpacity, ActivityIndicator,TextInput  } from 'react-native'
...
const Location = ({
  ...
  return (
    ...
    >
      { regionsLoading?<View style={styles.loading}>
      ...
      { districtsLoading?<View style={styles.loading2}>
      <ActivityIndicator size='large' color={colors.primary}/>
    </View>:<></>}
      <DropDownPicker
        containerStyle={{
    ...
    >
       { wardsLoading?<View style={styles.loading}>
      <ActivityIndicator size='large' color={colors.primary}/>
    </View>:<></>}
      <DropDownPicker
        containerStyle={{
      ...
      /> 
       { placesLoading?<View style={styles.loading2}>
      <ActivityIndicator size='large' color={colors.primary}/>
    </View>:<></>}
      <DropDownPicker
        containerStyle={{
